...
export interface Ec2InstanceEnv extends Pick<GlobalEnv, 'DELETION_PROTECTION_ENABLED'> {
  ...
  */
  ...
  EC2_INSTANCE_ROOT_BLOCK_SIZE: number | undefined;
  EC2_INSTANCE_ROOT_BLOCK_TYPE: string | undefined;

  // 1. EBS Block Device Configruation
  EC2_INSTANCE_EBS_BLOCK_DEVICE_NAME: string;
  EC2_INSTANCE_EBS_BLOCK_VOLUME_SIZE: number | undefined;
  EC2_INSTANCE_EBS_BLOCK_VOLUME_TYPE: string | undefined;
}
    ...
    return {
      ...
      ...Validators.makeLocal(name, {
        EC2_INSTANCE_AMI_ID: str({
          default: undefined,
          desc: 'AMI ID must be provided to create an EC2 instance. Without a valid AMI, the instance cannot be launched',
        }),
        EC2_INSTANCE_TYPE: str({
          default: undefined,
          desc: 'Instance type must be provided. EC2 instance cannot be created without a valid instance type',
        }),
        EC2_INSTANCE_KEY_NAME: str({
            default: undefined,
            desc: 'Ec2 instance key name must be provided. EC2 instance cannot be created without a key pair',
        }),
        EC2_INSTANCE_SUBNET_ID: str({
          default: undefined,
          desc: 'Ec2 instance subnet id must be provided. EC2 instance cannot be created without a subnet',
        }),
        EC2_INSTANCE_ROOT_BLOCK_DEVICE_NAME: str({
            default: undefined,
            desc: 'Ec2 instance root block device name must be provided. EC2 instance cannot be created without a root block device name',
        }),
        EC2_INSTANCE_ROOT_BLOCK_SIZE: number({
            default: undefined,
            desc: 'Ec2 instance root block size must be provided. EC2 instance cannot be created without a root block device size',
        }),
        EC2_INSTANCE_ROOT_BLOCK_TYPE: str({
            default: undefined,
            desc: 'Ec2 instance root block type must be provided. EC2 instance cannot be created without a root block device type',
        }),
        EC2_INSTANCE_EBS_BLOCK_DEVICE_NAME: str({
            default: undefined,
            desc: 'Ec2 instance ebs block device name must be provided. EC2 instance cannot be created without an EBS block device name',
        }),
        EC2_INSTANCE_EBS_BLOCK_VOLUME_SIZE: number({
            default: undefined,
            desc: 'Ec2 instance ebs block volume size must be provided. EC2 instance cannot be created without an EBS block device volume size',
        }),
        EC2_INSTANCE_EBS_BLOCK_VOLUME_TYPE: str({
            default: undefined,
            desc: 'Ec2 instance ebs block volume type must be provided. EC2 instance cannot be created without an EBS block device volume type',
        }),
      }),
    };
  }
